...
// Kludge for inability to configure "@babel/plugin-transform-react-jsx" plugin with option {"pragma": "h"} when using Babel browser transformation from CDN
const React = {createElement: m}
