...
And they all have various different warts (even Mithril). To be fair to React, after all those years of work that have gone into it, its error messages are sometimes better than Mithril's. With Mithril, it sometimes throws an exception and you have to work harder than with React to figure out exactly what part of your HyperScript code is the offending part. That rarely gets in the way of someone experienced with Mithril, but it can trip up beginners (e.g. having a key on some nodes but not others).
