...
const CurrencyConverterMany = {
	view: () => h("div", { id: "currency-converter", classes: { currencyError: model.currencyError, precisionError: model.precisionError } }, [
		h("div", [
			"Precision: ",
...
m.mount(document.body, CurrencyConverterMany)
...
Canadian Dollar,CAD,0.657,1.3063
